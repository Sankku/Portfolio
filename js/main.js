...
(() => {
    ...
    function popupDetails() {
        ...
        // get the project tittle
        const tittle = portfolioItems[itemIndex].querySelector(".portfolio-item-tittle").innerHTML;
        // set the project tittle
        popup.querySelector(".pp-tittle h2").innerHTML = tittle;
